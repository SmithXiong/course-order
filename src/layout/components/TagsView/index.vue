  ...
  <div id="tags-view-container" class="tags-view-container">
    ...
    <el-dropdown @command="handleTagAction">
      ...
      <el-dropdown-menu slot="dropdown">
        ...
        <el-dropdown-item command="closeSelectedTag" v-if="!(selectedTag.meta&&selectedTag.meta.affix)">关闭
        </el-dropdown-item>
        <el-dropdown-item command="closeOthersTags">关闭其它</el-dropdown-item>
